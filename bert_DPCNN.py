...
class Config(object):
    ...
    def __init__(self, dataset, device='cuda'):
        self.model_name = '1000intent_bertDPCNN'
        ...
        self.save_path = 'model_output/' + self.model_name + '.ckpt'  # 模型训练结果
...
class Model(nn.Module):
    ...
    def forward(self, x, predict=False):
        print(x.shape)
        if predict:
            encoder_out, pooled = self.bert(x, output_all_encoded_layers=False)
